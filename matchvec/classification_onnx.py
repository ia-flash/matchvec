...
class Classifier(BaseModel):
    ...
    def __init__(self, classification_model):
        self.files = ['classification_model_onnx1.5.onnx', 'idx_to_class.json']
        ...
        self.session = onnxruntime.InferenceSession(os.path.join(dst_path, "classification_model_onnx1.5.onnx"))
